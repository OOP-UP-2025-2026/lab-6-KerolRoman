...
public class DrawFrame extends JFrame {
    ...
    private JPanel setButtonPanel() {
        ...
        rect.addActionListener(e -> {
            ...
            surface.setShapeType(ua.opnu.list.model.DrawShape.SHAPE_RECTANGLE);
        });
        ...
        rounded_rect.addActionListener(e -> {
            ...
            surface.setShapeType(ua.opnu.list.model.DrawShape.SHAPE_ROUNDED_RECT);
        });
        ...
        ellipse.addActionListener(e -> {
            ...
            surface.setShapeType(ua.opnu.list.model.DrawShape.SHAPE_ELLIPSE);
        });
